# Week 7-9: Integration and Review - Theory

## Learning Objectives

By the end of this week-block, students will:
- Review all concepts from Years 1-2
- Understand how all components integrate into a complete system
- Understand signal coordination across the entire system
- Be able to manually execute simple programs
- Be prepared for CPU construction in Year 3

## Prerequisites

- All Year 1 concepts (electronics, logic, sequential circuits, ALU)
- All Year 2 concepts (memory, MAR, control signals, state machines)
...
**Current limitations**:
- Manual control (slow, error-prone)
- Limited memory (small address space)
- Simple operations (basic arithmetic)
- No automatic sequencing

**What Year 3 solves**:
- Automatic control unit
- Larger memory (still limited, but better)
- Instruction set (more operations)
- Automatic program execution

**What future years add**:
- 16-bit architecture (Year 5)
- More memory and I/O (Year 5-6)
- High-level programming (Year 6)
- Operating system concepts (Year 6)

## Common Misconceptions

1. **"Integration is just wiring"**: It requires understanding signal timing and coordination
2. **"Manual computer is useless"**: It teaches how automatic computers work
3. **"We're done learning"**: This is just the foundation for CPU construction
4. **"CPU is completely different"**: It's the same components with automatic control

## Connections to Year 3

- **SAP-1 CPU**: Uses all these components
- **Control Unit**: Automates what we do manually
- **Instruction Set**: Defines the operations
- **Program Execution**: Automatic version of manual execution

## Assessment Preparation

**What to demonstrate**:
- Manual execution of a simple program
- Correct signal coordination
