# Chapter 8: ALU Subsystem

## Introduction

In this chapter, you'll learn about the ALU (Arithmetic Logic Unit) - the part of the CPU that performs calculations. You'll build a complete ALU subsystem that can add, subtract, and generate flags.
...
1. What operations does ALU perform?
   - Answer: Addition, subtraction, logic operations

2. How does two's complement work?
   - Answer: Invert bits, add 1

3. Why are flags important?
   - Answer: CPU uses for decisions, comparisons

4. How does data flow through ALU?
   - Answer: Registers → Bus → ALU → Result → Bus → Store

5. How does ALU relate to CPU?
   - Answer: ALU is core of CPU, performs calculations
...
*Understanding ALU helps you understand CPU computation!*
