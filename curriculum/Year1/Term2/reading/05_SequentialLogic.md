...
Welcome to sequential logic! This is where computers get their memory. In this chapter, you'll learn how computers remember data using latches, flip-flops, and registers.
...
**Think of it like**:
- A light switch: Position determines on/off
- Always the same result for same position
...
**Think of it like**:
- A toggle switch: Remembers last state
- Same action can give different results
...
1. What's the difference between combinational and sequential logic?
   - Answer: Sequential has memory, combinational doesn't

2. Why is S=1, R=1 forbidden in SR latch?
   - Answer: Creates unstable, undefined state

3. How does clock control flip-flop operation?
   - Answer: Flip-flop only changes on clock edge

4. What is a register?
   - Answer: Group of flip-flops storing multiple bits

5. Why are registers important in CPUs?
   - Answer: Fast storage for data, addresses, instructions
...
*Understanding sequential logic helps you understand computer memory!*
