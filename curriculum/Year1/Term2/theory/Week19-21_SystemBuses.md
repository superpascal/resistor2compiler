# Week 19-21: System Buses - Theory

## Learning Objectives

After reading this material, you will understand:
- What a system bus is and why it's needed
- How buses work in computers
- What tri-state buffers are and how they work
- How to avoid bus contention
- How registers connect to buses
- How CPUs use buses for communication
...
- Memory
- Program Counter
- All connected to bus

**Operation**:
- One device drives bus at a time
- Control unit selects device
- Data flows through bus
- Simple and clear
